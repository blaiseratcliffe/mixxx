...
WaveformRendererCDJ::WaveformRendererCDJ(WaveformWidgetRenderer* waveformWidget,
        ::WaveformRendererAbstract::PositionSource type)
        : WaveformRendererSignalBase(waveformWidget),
          m_isSlipRenderer(type == ::WaveformRendererAbstract::Slip) {
}

void WaveformRendererCDJ::onSetup(const QDomNode& node) {
    Q_UNUSED(node);
}

void WaveformRendererCDJ::initializeGL() {
    WaveformRendererSignalBase::initializeGL();
    m_shader.init();
}

void WaveformRendererCDJ::paintGL() {
